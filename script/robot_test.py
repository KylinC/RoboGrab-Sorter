...
num_obj = 10
random_seed = 1234
workspace_limits = np.asarray([[0.5, 0.7], [-0.2, 0.2], [-0.0001, 0.32]]) # Cols: min max, Rows: y x z (define workspace limits in robot coordinates)
# ---------------------------------------------
...
test_case_file_name = "test-10-obj-00.txt"
